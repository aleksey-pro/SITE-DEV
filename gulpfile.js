...
gulp.task ('default', ['modernizr', 'scripts', 'sprite', 'fonts', 'bowerjs', 'bowercss', 'styles', 'HTML', 'jshint', 'browserSync', 'watch']);

 // 'gulp-inject' ,'images' http://geekswithblogs.net/shaunxu/archive/2015/02/17/10-awesome-gulp-plugins-working-with-angularjs-and-bower.aspx